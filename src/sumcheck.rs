...
use crate::{
    ...
    poly_f::{mle::dense::DenseMultilinearExtension, polynomials::ArithErrors},
...
pub struct SumcheckProof<const N: usize>(Vec<ProverMsg<N>>);

impl<const N: usize> MLSumcheck<N> {
    /// extract sum from the proof
    pub fn extract_sum(proof: &SumcheckProof<N>) -> RandomField<N> {
...
mod tests {
    ...
    ) -> (usize, RandomField<N>, SumcheckProof<N>) {
